...
using propvalue_t = x3::variant<double, identifier_t>;
...
using fdepl_define_t = pair<fdepl_define_header_t, dataset_t>;
x3::rule<class fdepl_define_id, fdepl_define_t> const fdepl_define { "fdepl_define" };

using fdepl_full_t = pair<identifier_t, fdepl_define_t>;
